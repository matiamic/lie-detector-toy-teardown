...
- **Sigrok Decoders**: Two custom decoders for analyzing signals. Modified timing decoder and lie detector toy decoder, that is written to be stacked on top of the timing decoder
